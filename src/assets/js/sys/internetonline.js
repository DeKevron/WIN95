    ...
    WIN95.internetonline.prototype = {
        constructor: WIN95.internetonline,
        set: function(data) {
            this.ID = data.ID;
        ...
        render: function(renderTarget) {
	        ...
	        var element = $(Mustache.render(
                WIN95.templates.internetonline, {
                    ID: this.ID,
                    image: this.image,
                    title: this.title,
        ...
        postRender: function(element) {
            $('.explorerContents .iol').click(function() {
                //ga('send', 'event', 'InternetOnline', 'myProfile');
                $('[data-icon=myProfile]').dblclick();
            });

        	$('.explorerContents .history').click(function() {
                //ga('send', 'event', 'InternetOnline', 'History');
